...
This outlines how to propose a change to ipaddress. For more detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("davidchall/ipaddress", fork = TRUE)`.
...
Code of
Conduct](https://davidchall.github.io/ipaddress/dev/CODE_OF_CONDUCT.md).
