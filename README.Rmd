...
The ipaddress packages provides classes for storing IP addresses and networks, in both the IPv4 and IPv6 address spaces. Its interface is inspired by by Python's [`ipaddress`](https://docs.python.org/library/ipaddress.html) and [`cyberpandas`](https://cyberpandas.readthedocs.io) modules.

Here are some of the features:

* IP addresses stored in their native representation (a sequence of bits) for **efficient data storage**
