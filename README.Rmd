...
The goal of ipaddress is to provide classes for working with IP addresses, which play nicely with the tidyverse.
I plan to emulate some of the features from Python's [`ipaddress`](https://docs.python.org/library/ipaddress.html) and [`cyberpandas`](https://cyberpandas.readthedocs.io) modules.
